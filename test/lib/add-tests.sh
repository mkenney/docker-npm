...
add_tests() {
    ...
    case $1 in
        release)
            ...
            ;;
<<<<<<< HEAD
        node-alpine/*|node-debian/*|node-9-alpine/*|node-9-debian/*|node-8-alpine/*|node-8-debian/*|node-7-alpine/*|node-7-debian/*|node-7.7-alpine/*|node-7.0-debian/*|node-6.9-alpine/*|node-6.9-debian/*)
=======
        node-alpine/*|node-debian/*|node-10-alpine/*|node-10-debian/*|node-8-alpine/*|node-8-debian/*|node-7-alpine/*|node-7-debian/*|node-7.7-alpine/*|node-7.0-debian/*|node-6.9-alpine/*|node-6.9-debian/*)
>>>>>>> alpine-latest
            tests="1.build"
            ;;
        .travis.yml)
